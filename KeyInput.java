...
public class KeyInput extends KeyAdapter {
    ...
    public void keyPressed(KeyEvent e) { 
        ...
        // Toggle debug overlay with F2 (single event per press)
        if (code == KeyEvent.VK_F2 && !f2Latch) {
            debugOn = !debugOn;
            f2Latch = true;
            
            double speedUp = !debugOn ? MovementSystem.entityDefaultSpeed : 0.8;
            MovementSystem.setSpeed(speedUp); //TODO here
             
            //System.out.println("Debug overlay: " + (debugOn ? "ON" : "OFF") + " speed " + MovementSystem.getSpeed() );
        }
    }
    ...
    public void keyReleased(KeyEvent e) {
        ...
        if (code == KeyEvent.VK_F2) {
            f2Latch = false; // reset latch so next press counts 
