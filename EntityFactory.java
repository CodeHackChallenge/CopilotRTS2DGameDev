...
public class EntityFactory {
    ...
    public static Entity createHero(double x, double y) {
        ...
        e.addComponent(new AttackCoolDown(10.0f)); //this control the atk speed 1f default
        e.addComponent(new AttackState());
        //e.addComponent(new AttackProfile(0.51f, 0.17f, 0.34f));
        //e.addComponent(new AttackProfile(0.34f, 0.17f, 0.51f));
        //e.addComponent(new AttackProfile(0.17f, 0.51f, 0.34f));  
        e.addComponent(new AttackProfile(0.17f, 0.51f, 0.34f )); //windup hitWindow recovery
